...
struct ni_testbus_tmpfile {
	...
	unsigned int		seq;		/* sequence number of last change */
...
extern ni_testbus_tmpfile_t *	ni_testbus_file_array_find_by_name(const ni_testbus_file_array_t *, const char *);
extern void			ni_testbus_file_array_merge(ni_testbus_file_array_t *result, const ni_testbus_file_array_t *);

extern ni_testbus_tmpfile_t *	ni_testbus_tmpfile_new(const char *, ni_testbus_file_array_t *);
extern ni_testbus_tmpfile_t *	ni_testbus_tmpfile_get(ni_testbus_tmpfile_t *);
