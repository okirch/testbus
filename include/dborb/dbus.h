 ...
 *
 * Copyright (C) 2011-2013 Olaf Kirch <okir@suse.de>
 */
...
typedef struct ni_dbus_objprops	ni_dbus_objprops_t;
...
struct ni_dbus_object {
	...
	ni_dbus_objprops_t *	cached_properties;
};
...
extern void			ni_dbus_server_add_signal_handler(ni_dbus_server_t *server,
					const char *sender,
					const char *object_path,
					const char *object_interface,
					ni_dbus_signal_handler_t *callback,
					void *user_data);
extern ni_dbus_client_t *	ni_dbus_server_create_shared_client(ni_dbus_server_t *server, const char *bus_name);
...
extern void *			ni_dbus_object_get_handle_typecheck(const ni_dbus_object_t *, const ni_dbus_class_t *, DBusError *);
...
extern dbus_bool_t		ni_dbus_object_get_properties_as_dict(const ni_dbus_object_t *object,
					...
					DBusError *error);
extern const ni_dbus_variant_t *ni_dbus_object_get_cached_property(const ni_dbus_object_t *, const char *, const ni_dbus_service_t *);
...
extern ni_dbus_variant_t *	ni_dbus_variant_new(void);
extern void			ni_dbus_variant_free(ni_dbus_variant_t *);
...
extern void			ni_dbus_variant_vector_init(ni_dbus_variant_t *, unsigned int count);
extern void			ni_dbus_variant_vector_destroy(ni_dbus_variant_t *, unsigned int count);
...
extern dbus_bool_t		ni_dbus_variant_get_string_array(const ni_dbus_variant_t *, ni_string_array_t *);
...
/* handle dicts */
extern ni_dbus_variant_t *	ni_dbus_dict_new(void);
...
extern dbus_bool_t		ni_dbus_dict_add_byte_array_buffer(ni_dbus_variant_t *, const char *,
					const ni_buffer_t *);
extern dbus_bool_t		ni_dbus_dict_add_string_array(ni_dbus_variant_t *, const char *, const char **, unsigned int len);
...
extern ni_buffer_t *		ni_dbus_dict_get_byte_array_buffer(const ni_dbus_variant_t *, const char *);
...
extern ni_dbus_message_t *	ni_dbus_client_call(ni_dbus_client_t *client, ni_dbus_message_t *call,
					DBusError *error);
extern void			ni_dbus_client_set_root_object(ni_dbus_client_t *client, ni_dbus_object_t *object);
extern ni_dbus_object_t *	ni_dbus_client_get_root_object(const ni_dbus_client_t *client);
...
typedef struct ni_dbus_lookup ni_dbus_lookup_t;
struct ni_dbus_lookup {
	const char *		name;
	ni_dbus_object_t *	(*lookup_by_name)(const ni_dbus_lookup_t *, const char *);
	ni_dbus_object_t *	(*lookup_by_attrs)(const ni_dbus_lookup_t *, const ni_var_array_t *);
	ni_bool_t		(*match_attr)(const ni_dbus_object_t *, const char *, const char *);
	ni_bool_t		(*describe)(const ni_dbus_lookup_t *, const ni_dbus_object_t *, xml_node_t *);
};

extern void			ni_dbus_register_lookup(ni_dbus_lookup_t *);
extern void			ni_dbus_register_builtin_lookups(void);
extern void			ni_dbus_register_dynamic_lookups(void);
extern const ni_dbus_lookup_t *	ni_dbus_get_lookup(const char *);
extern ni_dbus_object_t *	ni_dbus_lookup_by_attrs(ni_dbus_object_t *list_object,
						const ni_dbus_lookup_t *, const ni_var_array_t *);
extern xml_node_t *		ni_dbus_object_get_names(const ni_dbus_object_t *object);
