...
#define __NI_DBUS_GENERIC_NAMESPACE		"org.opensuse"

#define __NI_DBUS_ERROR(x)			__NI_DBUS_GENERIC_NAMESPACE "." #x
...
#define NI_DBUS_ERROR_NAME_EXISTS		__NI_DBUS_ERROR(NameExists)
#define NI_DBUS_ERROR_NAME_UNKNOWN		__NI_DBUS_ERROR(NameUnknown)
#define NI_DBUS_ERROR_NAME_INVALID		__NI_DBUS_ERROR(NameInvalid)
#define NI_DBUS_ERROR_NOT_COMPATIBLE		__NI_DBUS_ERROR(NotCompatible)
#define NI_DBUS_ERROR_IN_USE			__NI_DBUS_ERROR(InUse)
#define NI_DBUS_ERROR_BAD_SIZE			__NI_DBUS_ERROR(BadSize)
#define NI_DBUS_ERROR_AGENT_OFFLINE		__NI_DBUS_ERROR(AgentOffline)

/* Map dbus error strings to our internal error codes and vice versa */
extern void		ni_dbus_set_error_from_message(DBusError *, DBusMessage *);
...
extern void		ni_dbus_set_error_from_errno(DBusError *, int, const char *fmt, ...);
